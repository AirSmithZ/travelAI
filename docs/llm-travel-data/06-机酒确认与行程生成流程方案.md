...
2. 每日晚宿靠近 `hotels[]` 中覆盖该日的 `is_primary` 酒店
3. 不得修改已确认航班时刻/酒店名；仅排 POI 与市内交通
4. `cross_day_edges[]` 应用 `transport_mode: 'flight'` 连接跨日航班边
...
| **P3** | ⏳ | 多航段模板、城际快捷入口 | → **B-P3-01** [TODO](./TODO.md) |
...
| **P6** | ⏳ | 多酒店 + 校验 | → **B-P6-01** [TODO](./TODO.md) |
